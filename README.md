...
- Адаптив под 1440, 768 и 375 px: на планшете две колонки сохраняются, на мобильном блок складывается в одну колонку: категория и название над фото, описание уходит под кнопку.
...
- [x] 375 px: одна колонка; порядок: категория, название, фото, фасовка, цена, кнопка, артикул, описание; горизонтального скролла нет.
